       ...
       <>
          ...
          >
            ...
            <Routes>
              ...
              <Route path="/differences" element={<OnlyDifferencesPage path="/differences" getData={getData} setCurrent={setCurrent} current={current} setObject={setObject} currentBpmn={currentBpmn}  notSameScenario={notSameScenario} setNotSameScenario={setNotSameScenario} data={data} currentScenario={currentScenario} scenariosCompare={scenariosCompare} setScenariosCompare={setScenariosCompare}/>} />
