                ...
                <Card bg="white" mt="25px">
                    ...
                    <CardBody>
                        <Table variant='simple'>
                            ...
                            <Tbody>
                                <Tr>
                                    <Td style={getColor("scenarioName")}>{props.getData("currentScenario").scenarioName}</Td>
                                    <Td style={getColor("startingDate")}>{props.getData("currentScenario").startingDate}</Td>
                                    <Td style={getColor("startingTime")}>{props.getData("currentScenario").startingTime}</Td>
                                    <Td style={getColor("numberOfInstances")}>{props.getData("currentScenario").numberOfInstances}</Td>
                                </Tr>
