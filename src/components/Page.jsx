...
function Page(props){
    ...
    const Switcher = () => {
        switch (props.current) {
            case "Modelbased Parameters":  return <BpmnViewSelector current={props.current} currentBpmn={props.currentBpmn} bpmns={props.bpmns} setObject={props.setObject} zIndex={-5} />        
